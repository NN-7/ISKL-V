...
- Server (server.py) **NOT COMPLETED**
  ...
  - Can recieve ZIP files, unpack them, and organize their contents by file type.
- Starter (main.py) **NOT COMPLETED**
  - Downloads the scripts if they aren't available locally and starts the virus
...
- Starter
  - A mechanism that downloads any part of the virus that is needed and begins everything
